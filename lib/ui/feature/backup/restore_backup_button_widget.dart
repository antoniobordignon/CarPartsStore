...
class RestoreBackupButtonWidget extends StatelessWidget {
  const RestoreBackupButtonWidget({super.key});
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
              ...
              child: switch (viewModel.state) {
                BackupState.restoring => CircularProgressIndicator(
